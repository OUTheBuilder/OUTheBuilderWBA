...
function DrivePage({
  ...
  return (
    <PageHeader
      eyebrow="STORAGE"
      title="Google Drive"
      description="Connect your Google account for project storage and application data."
    >
      ...
      <section className="panel centered-panel">
        ...
        <span className="coming-soon">
          OAuth connection test — Drive storage integration follows
        </span>
    ...
    >
      ...
      <div className="settings-list">
        ...
        <SettingItem
          ...
          value={googleConnected ? 'Google Drive Connected' : 'Local Foundation'}
          onClick={() => setOpenSection(openSection === 'storage' ? null : 'storage')}
        />

        {openSection === 'storage' && (
          <section className="panel settings-detail">
            <PanelHeader title="Storage" subtitle="Google Drive connection" />
